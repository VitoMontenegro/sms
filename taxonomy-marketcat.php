...
add_filter('body_class', function( $classes ){
    $classes[] = ' page-template-categorypage dark';
    return $classes;
} );
$query_data = get_fields();
$poster = $query_data['image'] ?? '1234';
get_header();
$categories = get_terms( array( 'taxonomy' => 'marketcat') );
                    ...
                    <div class="container">
                        ...
                        <div class="blog-page__container">
                            <div class="blog-page__categories text-center">
                                <a href="<?php echo get_page_link( 168 );?>" class="blog-page__subtitle colors--white">Разделы</a>
                                <ul class="cat-items colors--white">
                                    <?php foreach($categories as $cat): ?>
                                        <li class="cat-item cat-item-3">
                                            <a href="/marketcat/<?php echo $cat->slug; ?>"><?php echo $cat->name . ' ';?></a>
                                        </li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
