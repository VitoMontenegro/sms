        ...
        <nav id="nav-main" class="navbar navbar-expand-xl">
          ...
          <div class="container">
            ...
            <a class="navbar-brand" href="<?php echo esc_url(home_url()); ?>">
                <img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/img/logo/logo.svg" alt="logo" class="logo md is_light">
                <img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/img/logo/logo-dark.svg" alt="logo" class="logo md is_dark">
            </a>
